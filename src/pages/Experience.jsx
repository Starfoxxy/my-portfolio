...
const experiences = [
  {
    ...
    location: "Remote, NY",
    period: "2025 - Present",
    description: "Collaborating with Prometheus and TAP team to design and develop TAP's Events page, implementing dynamic filtering, responsive UI, and API integrations using Next.js, React, and Tailwind CSS.",
    highlights: [
...
const education = [
  {
    ...
    degree: "Innovation Fellowship - Web Development Track",
    period: "Expected Dec 2025",
    details: "Completing 900+ hours of intensive full-stack training. Building and deploying 5+ applications using JavaScript, React, Express, Node.js, and Tailwind.",
  },
  {
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {education.map((edu, i) => (
              ...
              >
                ...
                <p className="font-mono font-bold mb-2" style={{ color: i === 0 ? '#00ffff' : '#ff00ff' }}>
                  {edu.degree}
                </p>
